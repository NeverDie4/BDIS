...
| external_source | VARCHAR(50) | 否 | NULL | UK | 外部来源系统，如 SOAP |
...
**唯一约束 / 唯一索引：** uk_herb_growth_record_external_identity(external_source, external_no)
...
| M10 | 采集审核与溯源模块 | herb_growth_review_record、herb_growth_record、herb_batch | 已覆盖 |
