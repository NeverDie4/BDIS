...
> 本次修订：补充 M05、M06、M19 实现所需字段，并同步 `V20260713_004` 的文件关联唯一约束、文件访问失败原因和审计组合索引；同步 M12-M15 迁移字段、培训素材表及关联约束。
...
### 6.44 M12-M15 迁移补充（V20260713_004 至 V20260713_009）
...
| 版本 | 日期 | 修订内容 |
|---|---|---|
| V1.1 | 2026-07-14 | 同步 M12-M15 迁移字段、索引、唯一约束及培训素材表。 |
