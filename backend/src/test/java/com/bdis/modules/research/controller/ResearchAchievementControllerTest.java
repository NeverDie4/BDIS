...
class ResearchAchievementControllerTest {
    ...
    void achievementRoutesUseDedicatedPermissions() throws Exception {
        ...
        mockMvc.perform(
                        post("/research-achievements")
                                .contentType("application/json")
                                .content(
                                        "{\"achievementNo\":\"A-001\",\"projectId\":1,\"achievementName\":\"Paper\",\"achievementType\":\"paper\"}"))
                .andExpect(status().isOk());
        mockMvc.perform(
                        put("/research-achievements/20")
                                .contentType("application/json")
                                .content(
                                        "{\"achievementName\":\"Updated\",\"achievementType\":\"paper\",\"achievementStatus\":\"draft\",\"version\":0}"))
                .andExpect(status().isOk());
    }
