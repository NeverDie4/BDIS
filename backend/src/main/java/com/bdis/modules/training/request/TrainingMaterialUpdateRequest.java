...
public class TrainingMaterialUpdateRequest {
    ...
    @Null(message = "materialNo cannot be changed")
    private String materialNo;

    @Null(message = "uploaderId cannot be changed")
    private Long uploaderId;

    @Null(message = "uploadedAt cannot be changed")
    private java.time.LocalDateTime uploadedAt;

    @Null(message = "reuseCount cannot be changed")
