...
import com.bdis.audit.entity.FileAccessLogEntity;
import com.bdis.audit.mapper.FileAccessLogMapper;
...
public class FileAccessLogServiceImpl implements FileAccessLogService {
    ...
    public PageResult<FileAccessLogVO> page(FileAccessLogQuery query) {
        Page<FileAccessLogEntity> page = new Page<>(query.getPageNum(), query.getPageSize());
        LambdaQueryWrapper<FileAccessLogEntity> wrapper =
                new LambdaQueryWrapper<FileAccessLogEntity>()
                        .eq(query.getFileId() != null, FileAccessLogEntity::getFileId, query.getFileId())
                        .eq(query.getOperatorId() != null, FileAccessLogEntity::getOperatorId, query.getOperatorId())
                        .eq(query.getAccessType() != null, FileAccessLogEntity::getAccessType, query.getAccessType())
